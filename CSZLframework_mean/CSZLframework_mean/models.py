...
class LGBmodel_highstop(BaseModel):
    ...
    def core_predict(self,train,modelpath,savepath):
        ...
        y_train = np.array(train['tomorrow_high_stop'])
        train.drop(['tomorrow_chg','tomorrow_chg_rank','ts_code','trade_date','tomorrow_high_stop'],axis=1,inplace=True)
...
class LRmodel(BaseModel):
    def core_predict(self, train, modelpath, savepath):
        ...
        LR_model = joblib.load(modelpath)

        pred_test = LR_model.predict_proba(train)
